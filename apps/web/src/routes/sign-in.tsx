    ...
    <div className="series-paper flex min-h-screen flex-col bg-[#fff3cf]">
      <main className="grid flex-1 lg:grid-cols-[0.92fr_1.08fr]">
        ...
        <div className="relative max-w-md">
          ...
          <h1 className="text-4xl font-semibold leading-tight">Your Series AV library follows you.</h1>
          <p className="mt-5 text-base leading-7 text-white/70">
            Sign in to keep your shows, next episodes, and Avi recommendations connected with your AV account.
          </p>
        </div>
          ...
          <div className="w-full max-w-md">
            ...
            <SignedIn>
              <div className="rounded-2xl border border-[#d7c494] bg-[#fff8df] p-6 text-center shadow-lg shadow-[#172f5c]/10">
                <p className="text-sm font-semibold text-[#112a55]">You are signed in.</p>
      ...
      <AvAppFooter product={seriesProductConfig} />
    </div>
  );
}
