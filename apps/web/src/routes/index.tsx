...
import { AppGridSkeleton, AppSurfaceState, CompactSyncStatus, useAppsAvLocale } from "@avalsys/apps-av-web";
      ...
      <section className="relative isolate overflow-hidden rounded-lg border border-[#d7c494] bg-[#fff8df] shadow-lg shadow-[#172f5c]/8">
        ...
        <div className="grid gap-6 p-6 sm:p-8 xl:grid-cols-[minmax(0,1fr)_18rem] xl:items-end">
          ...
          {shouldShowCurrentSkeleton ? (
            ...
            <div className="self-end rounded-[1.25rem] border border-[#d7c494] bg-white/76 p-4 shadow-lg shadow-[#172f5c]/10 backdrop-blur">
              <SeriesArtwork entry={current} size="md" />
              <div className="mt-4">
                <h2 className="text-xl font-semibold text-[#112a55]">{currentTitle ?? labels.loadingTitle}</h2>
